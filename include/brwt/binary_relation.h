...
public:
  ...
  using label_type = types::word_type;
  using object_type = types::size_type;
  ...
  ///
  size_type rank(label_type label_max, object_type obj_max) const noexcept;

  /// \brief Counts the number of pairs in the specified range.
  ///
  size_type rank(label_type label_max, object_type obj_min,
                 object_type obj_max) const noexcept;
  ...
  ///
  pair_type select_label_major(label_type alpha, object_type x, object_type y,
  ...
  ///
  pair_type select_object_major(label_type alpha, label_type beta,
                                object_type x, size_type nth) const noexcept;
  ...
  ///
  pair_type lower_bound_object_major(label_type alpha, label_type beta,
  ...
  ///
  object_type object_select(label_type fixed_label, object_type obj_min,
                            size_type nth) const noexcept;
  ...
  ///
  size_type count_distinct_labels(label_type alpha, label_type beta,
                                  object_type x, object_type y) const noexcept;
...
private:
  index_type map(object_type x) const noexcept;
  object_type unmap(index_type pos) const noexcept;
